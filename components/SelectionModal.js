...
export default function SelectionModal({ visible, title, options = [], onCancel }) {
    ...
    const renderItem = ({ item }) => (
        ...
        >
            ...
            <View style={styles.optionTextContainer}>
                <Text style={styles.optionLabel}>{item.text || item.label}</Text>
                {item.description && (
                            ...
                            ListFooterComponent={() => (
                                <>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        activeOpacity={0.7}
                                    >
                                        <View style={[styles.optionIconContainer, { backgroundColor: COLORS.errorLight }]}>
