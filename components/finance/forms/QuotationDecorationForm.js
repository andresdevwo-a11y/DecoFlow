...
const QuotationDecorationForm = ({ initialValues, onSubmit, onCancel, submitLabel = 'Guardar Cotización', isSubmitting = false }) => {
                ...
                >
                    ...
                    <View style={styles.sectionContainer}>
                        ...
                        <View style={[styles.totalContainer, { backgroundColor: THEME_COLOR_LIGHT, borderColor: THEME_COLOR, marginBottom: 0 }]}>
                            <View>
                                <Text style={styles.totalLabel}>Total Decoración</Text>
                            </View>
...
export default QuotationDecorationForm;
