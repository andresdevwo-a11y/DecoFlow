...
const QuotationSaleForm = ({ initialValues, onSubmit, onCancel, submitLabel = 'Guardar Cotización', isSubmitting = false }) => {
    ...
    const handleSubmit = async () => {
        ...
        const formData = {
            ...
            // Explicitly set installment fields to false/0 for quotations
            isInstallment: false,
        ...
        try {
            ...
            if (!selectedClientId) {
                ...
                // CASE B: Existing client selected
                onSubmit({
                    ...formData,
            ...
            >
                ...
                >
                    ...
                    <View style={styles.sectionContainer}>
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Ej: Cotización de Equipos..."
                    ...
                    <View style={styles.sectionContainer}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: SPACING.md }}>
                            <Text style={[styles.sectionTitle, { marginBottom: 0, borderBottomWidth: 0 }]}>3. Ítems ({items.length})</Text>
                    ...
                    {/* SECCIÓN 4: DETALLES DE COTIZACIÓN */}
                    <View style={styles.sectionContainer}>
                        <Text style={styles.sectionTitle}>4. Detalles General</Text>
                        ...
                        <TextInput
                            ...
                            placeholder="Términos, condiciones o notas..."
                            placeholderTextColor={COLORS.textMuted}
                            value={notes}
...
export default QuotationSaleForm;
