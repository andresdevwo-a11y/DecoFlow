...
export default function CreateProductScreen({ onBack, onCreate }) {
    ...
    return (
        <View style={styles.container}>
            {/* Header */}
            <Header title="Crear producto" onBack={onBack} />
            ...
            {/* Fixed Bottom Footer - Mimicking BottomNavBar container */}
            <View style={[
                styles.footer,
                {
                    height: SIZES.navBarHeight + insets.bottom,
                    paddingBottom: insets.bottom,
                    paddingHorizontal: SPACING.lg, // Maintain side padding for the button
                    justifyContent: 'center', // Center button vertically in the available space above safe area
                }
            ]}>
                <TouchableOpacity
                    style={[styles.createButton, !isFormValid && { backgroundColor: COLORS.primaryDisabled }]}
...
const styles = StyleSheet.create({
    ...
    inputWrapperFocused: {
        ...
        backgroundColor: COLORS.surface, // Or maybe a very subtle tint
    },
    input: {
        paddingVertical: 12,
    ...
    textArea: {
        minHeight: 120, // Taller description area
